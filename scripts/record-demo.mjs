...
async function loadChromium() {
  try {
    ...
    const hunterRequire = createRequire("C:/Users/Ricky/Documents/Project/hackathonhunter-skill/package.json");
    return hunterRequire("playwright").chromium;
  }
}
...
try {
  ...
  await page.locator("[data-proof-status]").first().scrollIntoViewIfNeeded();
  await page.waitForTimeout(1200);
